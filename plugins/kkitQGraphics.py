...
class KineticsDisplayItem(QGraphicsWidget):
    ...
    def itemChange(self,change,value):
        ...
        if change == QtWidgets.QGraphicsItem.ItemPositionChange:
            ...
            self.qgtextPoisitionChage.emit(self.mobj)
        if change == QtWidgets.QGraphicsItem.ItemSelectedChange and value == True:
            ...
            self.qgtextItemSelectedChange.emit(element(self.mobj))
...
class GRPItem(QGraphicsRectItem):
    ...
    def itemChange(self,change,value):
        ...
        if change == QGraphicsItem.ItemPositionChange:
            ...
            #self.grpEmitter.qgtextPoisitionChage.emit(self.mobj)
            pass
